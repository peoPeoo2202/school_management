...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-graduation-cap"></i> Báo cáo kết quả học tập</h1>
            <div class="btn-group">
        ...
        <div class="main-content">
            <h2 class="page-title">Báo cáo kết quả học tập toàn trường</h2>
                        ...
                        <?php if (empty($duLieuBaoCao)): ?>
                            <tr>
                                <td colspan="15" class="no-data">
                                    <i class="fas fa-info-circle"></i> Không có dữ liệu để hiển thị. Vui lòng chọn bộ lọc phù hợp.
                                </td>
                            </tr>
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td><strong><?php echo $row['diemTrungBinh'] ? number_format($row['diemTrungBinh'], 1) : '-'; ?></strong></td>
                                <td><?php echo htmlspecialchars($row['tenGiaoVien'] ?? 'Chưa phân công'); ?></td>
                            </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </tbody>
