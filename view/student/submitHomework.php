        ...
        <style>
            * {
            ...
            .view-homework-btn {
                ...
                gap: 8px;
                pointer-events: none;
                /* Thêm dòng này để không chặn click của thẻ cha */
            }
...
?>
        ...
        <style>
            * {
            ...
            .homework-header-card {
                padding: 16px;
                background: linear-gradient(180deg, rgba(92, 156, 224, 1)0%, rgba(99, 145, 224, 1) 50%, rgba(80, 129, 190, 1) 100%);
                color: white;
                text-align: center;
                min-height: 95px;
            }
    ...
    <body>
        <div class="title-header">
            <h4 class="header-link"><a href="index.php?page=submitHomework">
                    <i class="fas fa-home"></i> Danh sách bài tập
                </a> <span class="separator">/</span>
                <?php echo htmlspecialchars($subjectName); ?></h4>
        </div>
                            ...
                            <div class="homework-info-grid">
                                ...
                                <div class="info-value-card">
                                    <span class="deadline-badge <?php echo $isLate ? 'deadline-warning' : 'deadline-ok'; ?>">
                                        ...
                                        <?php if ($isLate): ?>(quá hạn)<?php endif; ?>
                                    </span>
                                </div>
