        ...
        <div class="content-area">
            ...
            <?php else: ?>
                ...
                <div class="card">
                    ...
                    <div class="info-box" style="background: linear-gradient(135deg, #5081BE15 0%, #4a6fa515 100%); padding: 20px; border-radius: 8px; margin-bottom: 25px; border-left: 4px solid #5081BE;">
                        <h3>
                    ...
                    <div class="tab-row">
                        ...
                        <div class="semester-select">
                            ...
                            <select class="form-select" name="hocKy" id="hocKy" onchange="loadData()">
                                <option value="1" <?= ($data['hocKy'] == 1) ? 'selected' : '' ?>> Học kỳ 1</option>
                                <option value="2" <?= ($data['hocKy'] == 2) ? 'selected' : '' ?>> Học kỳ 2</option>
                            </select>
                        </div>
                    </div>
    ...
    <script>
            ...
            students.forEach((student, index) => {
                ...
                html += `
                    <tr>
                        ...
                        <td class="center">${tenDanhHieu ? formatTitle(tenDanhHieu) : '<span class ="badge badge-default">Chưa xếp</span>'}</td>
                    </tr>
                `;
            });
        ...
        function formatTitle(title) {
            ...
            if (title.includes('xuất sắc') || title.includes('Xuất sắc')) {
                return `<span class="badge badge-success"><i class="fas fa-trophy"></i> ${title}</span>`;
            } else if (title.includes('giỏi') || title.includes('Giỏi')) {
                return `<span class="badge badge-primary"><i class="fas fa-medal"></i> ${title}</span>`;
            }

            return `<span class="badge badge-default">${title}</span>`;
        }
